...
setup(
    ...
    keywords="LoRa, UART, EByte, esp32, esp8266, stm32, SAMD, Arduino, Raspberry Pi Pico, Raspberry Pi",
    url="https://github.com/mike7109/EByte_LoRa_E220_python_tinker2s_library",
    ...
    classifiers=[
        ...
        "Programming Language :: Python :: Implementation :: Raspberry Pi",
